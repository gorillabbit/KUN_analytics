...
def make_basedata():
    ...
    df_base.to_excel('H:/Projects/Glaphs/basedata.xlsx')
...
#plt.title('再生数と1000再生あたりの低評価数の関係', fontname=font)
#plt.scatter(df_base['再生数'], df_base['低評価数(再生数比x1000)'], s=2)
#plt.ylim(0, 5)
#fig.savefig('H:/Projects/Glaphs/unlike_rate_and_view.png')

plt.title('再生数と高-低評価比率の関係', fontname=font)
plt.scatter(df_base['再生数'], df_base['高評価-低評価比率'], s=2)
fig.savefig('H:/Projects/Glaphs/like_unlike_rate_and_view.png')
plt.xscale("log")
plt.show()
